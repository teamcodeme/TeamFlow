...
.PHONY: help doctor validate-roadmap docs-serve clean dev test build format lint
...
validate-roadmap: ## Validate roadmap JSON references and values
	@python3 scripts/validate_roadmap.py
docs-serve: ## Serve the static documentation site locally on port 4173
...
build: validate-roadmap ## Build applications after scaffolding
	@echo "Application build targets are pending scaffolding."
